...
def read_wvg(chamber, session):
    folder = 'processed_data'
    edge_weights_i_name = '%s/happy_wvg_%s_%s_weights_by_i.npy' % (folder, chamber, session)
    edge_weights_t_name = '%s/happy_wvg_%s_%s_weights_total.npy' % (folder, chamber, session)
    party_name = '%s/happy_wvg_%s_%s_party.npy' % (folder, chamber, session)
